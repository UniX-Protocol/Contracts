...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    function addLiquidity(
        ...
        // console.log("tokenA: %o amountA: %o",tokenA,amountA);
        // console.log("tokenB: %o amountB: %o",tokenB,amountB);
        // uint a = IERC20(tokenA).balanceOf(to);
        // console.log("tokenA Balance: %o to: %o",a,to);
